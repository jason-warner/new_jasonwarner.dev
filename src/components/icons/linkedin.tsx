...
export const LinkedInSVG = () => (
    <svg className="hover:fill-secondaryFont transition ease-in-out" fill="#FFF" height="100%" width="100%" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
